...
class SegDetector(nn.Module):
    ...
    def forward(self, features, gt=None, masks=None, training=False):
        ...
        # print('binary',binary.shape, type(binary))
        # print('thresh_binary',thresh_binary.shape, type(thresh_binary))
        
        # tmp1 = thresh_binary[0,0].cpu().numpy()
        # cv2.imwrite('./thresh_binary.jpg', tmp1*255)
        
        # tmp2 = thresh[0,0].cpu().numpy()
        # cv2.imwrite('./thresh.jpg', tmp2*255)
        return result
